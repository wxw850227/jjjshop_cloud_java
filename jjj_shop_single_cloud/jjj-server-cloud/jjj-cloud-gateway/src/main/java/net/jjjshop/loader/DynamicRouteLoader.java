...
import net.jjjshop.common.util.RedisUtil;
import net.jjjshop.config.GatewayRoutersConfig;
import net.jjjshop.config.RouterDataType;
import net.jjjshop.loader.repository.DynamicRouteService;
import net.jjjshop.loader.repository.MyInMemoryRouteDefinitionRepository;
import net.jjjshop.loader.vo.MyRouteDefinition;
import net.jjjshop.loader.vo.PredicatesVo;
...
//    }
    ...
    private void loadRoutesByNacos() {
        ...
        try {
            log.info("jjjshop.route.config.data-id = {}", gatewayRoutersConfig.getDataId());
