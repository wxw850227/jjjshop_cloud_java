...
public class UserRankingServiceImpl implements UserRankingService {
    ...
    public JSONObject getData() throws ParseException {
        ...
        Long userTotalToday = userService.getUserData(null, null, "user_total");
        Long userTotalYesterday = userService.getUserData(null, null, "user_total");
        Long userAddToday = userService.getUserData(today, null, "user_add");
        Long userAddYesterday = userService.getUserData(yesterday, null, "user_add");
    ...
    public JSONObject getPayScaleData(Integer day) throws ParseException {
        ...
        Long pay = userService.getUserData(startDate, endDate, "user_pay");
        Long noPay = userService.getUserData(startDate, endDate, "user_no_pay");
        JSONObject json = new JSONObject();
        json.put("pay", pay);
