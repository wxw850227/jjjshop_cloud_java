...
public class ProductCommentServiceImpl extends BaseServiceImpl<ProductCommentMapper, ProductComment> implements ProductCommentService {
     ...
     */
    @Override
    public Long getProductCommentTotal() {
     ...
     */
    @Override
    public Long getReviewCommentTotal() {
    ...
    @Override
    public Long getSupplierTotalByDate(Date date) {
        return this.count(new LambdaQueryWrapper<ProductComment>()
                .between(ProductComment::getCreateTime, DateUtil.getDateStart(date), DateUtil.getDateEnd(date))
                .eq(ProductComment::getIsDelete, 0)
        );
    }
}
