...
public class UserServiceImpl extends BaseServiceImpl<UserMapper, User> implements UserService {
    ...
    public Paging<UserVo> getList(UserPageParam userPageParam) {
        ...
        if(userPageParam.getStartDate() != null){
            wrapper.ge(User::getCreateTime,  userPageParam.getStartDate() + " 00:00:00");
        }
        if(userPageParam.getEndDate() != null){
            wrapper.le(User::getCreateTime,userPageParam.getEndDate() + " 23:59:59");
        }
    ...
    //获取订单统计数据
    @Override
    public Long getUserData(String startDate, String endDate, String type) throws ParseException {
        LambdaQueryWrapper<User> wrapper = new LambdaQueryWrapper<>();
        //开始查询时间不为空
