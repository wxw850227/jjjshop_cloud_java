...
public class ExtractUtils {
    ...
    private String getPosterPath(User user, Integer orderId) {
        ...
        return tempPath + "/extract/" + user.getTenantId() + "/" + this.getPosterName(user, orderId);
    }
    ...
    private String getPosterUrl(User user, Integer orderId) {
        return springBootJjjProperties.getResourceAccessUrl() + "temp/extract/" + user.getTenantId() + "/" + this.getPosterName(user, orderId) + "?t=" + System.currentTimeMillis();
    }
}
