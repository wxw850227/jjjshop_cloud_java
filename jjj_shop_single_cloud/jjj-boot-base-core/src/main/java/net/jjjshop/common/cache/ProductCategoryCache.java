...
public class ProductCategoryCache {
    ...
    public void clearCache() {
        redisTemplate.delete(String.format(CommonRedisKey.PRODUCT_CATEGORY_DATA, RequestDetailThreadLocal.getRequestDetail().getTenantId()));
    }
    ...
    public List<CategoryVo> getCache() {
        String cacheKey = String.format(CommonRedisKey.PRODUCT_CATEGORY_DATA, RequestDetailThreadLocal.getRequestDetail().getTenantId());
