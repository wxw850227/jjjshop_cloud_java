package net.jjjshop.common.desensitization;
...
import net.jjjshop.common.desensitization.annotation.Sensitive;
import net.jjjshop.common.desensitization.enums.SensitiveEnum;
import net.jjjshop.common.desensitization.util.SensitiveInfoUtil;
import net.jjjshop.common.util.encryption.AesEncryptUtil;
