...
public class PrinterFactory {
    ...
    public void print(Order order) {
        JSONObject vo = settingUtils.getSetting(SettingEnum.PRINTING.getKey(), Long.valueOf(order.getTenantId()));
    ...
    private String getPrintContent(Order order) {
        JSONObject storeJson = settingUtils.getSetting("store", Long.valueOf(order.getTenantId()));
        ...
        if (order.getDeliveryType().equals(DeliveryTypeEnum.EXPRESS.getValue())) {
            content.append("--------------------------------<BR>");
        ...
        if (order.getDeliveryType().equals(DeliveryTypeEnum.EXTRACT.getValue()) && extract != null) {
            content.append("--------------------------------<BR>");
