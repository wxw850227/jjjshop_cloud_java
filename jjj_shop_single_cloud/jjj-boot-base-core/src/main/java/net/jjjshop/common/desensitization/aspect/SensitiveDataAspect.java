package net.jjjshop.common.desensitization.aspect;

import lombok.extern.slf4j.Slf4j;
import net.jjjshop.common.desensitization.annotation.SensitiveDecode;
import net.jjjshop.common.desensitization.annotation.SensitiveEncode;
import org.aspectj.lang.ProceedingJoinPoint;
import org.aspectj.lang.annotation.Around;
import org.aspectj.lang.annotation.Aspect;
import org.aspectj.lang.annotation.Pointcut;
import org.aspectj.lang.reflect.MethodSignature;
import net.jjjshop.common.desensitization.util.SensitiveInfoUtil;
...
public class SensitiveDataAspect {
     ...
     * 定义切点Pointcut
     */
    @Pointcut("@annotation(net.jjjshop.common.desensitization.annotation.SensitiveEncode) || @annotation(net.jjjshop.common.desensitization.annotation.SensitiveDecode)")
