            ...
            if (flag && result != null && result instanceof ApiResult) {
                ...
                if (apiResult.getCode() == 1) {
                    ...
                    if ("登录成功".equals(optName)) {
                        ...
                        LoginShopUserVo loginShopUser = loginShopUserVo.getLoginShopUserVo();
                        shopLoginLog.setUsername(loginShopUser.getUserName());
                        shopLoginLog.setTenantId(loginShopUser.getTenantId());
                    } else {
