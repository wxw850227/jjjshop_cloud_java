<template>
  <el-dialog title="超链接设置" v-model="dialogVisible" @close="dialogFormVisible" 
    ...
    <el-tabs type="border-card" v-model="activeName">
      ...
      <el-tab-pane label="商品" name="product"><ProductIndex v-if="activeName == 'product'" @changeData="activeDataFunc"></ProductIndex></el-tab-pane>
...
import ProductIndex from './part/ProductIndex.vue';
