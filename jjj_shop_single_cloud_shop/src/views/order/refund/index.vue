      ...
      >
        ...
        <el-form-item label="售后类型">
          <el-select v-model="formInline.type" placeholder="请选择">
            ...
            <el-option label="退款" value="30"></el-option>
          </el-select>
        </el-form-item>
        ...
        >
          ...
          <el-table-column fixed="right" label="操作" width="120">
            <template #default="scope">
              <p>
                <el-button
                  @click="detailsClick(scope.row, 'detail')"
                  type="text"
                  size="small"
                  >详情</el-button
                >
                ...
                <el-button
                  v-if="
                    ...
                    (scope.row.type == 20 &&
                      ...
                      scope.row.isPlateSend == 0) ||
                    (scope.row.type == 10 &&
                      scope.row.isReceipt == 0 &&
                      scope.row.isAgree == 10 &&
                      scope.row.isUserSend == 1)
                  "
                  @click="detailsClick(scope.row, 'goods')"
                  type="text"
                  size="small"
                  >审核</el-button
                >
...
export default {
  ...
  methods: {
    detailsClick(row, type) {
      this.types = type;
      this.orderRefundId = row.orderRefundId;
      this.modals = true;
    },
    closeDialogFunc(e, f) {
      if (f == "detail") {
