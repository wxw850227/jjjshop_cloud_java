		...
		<el-form size="small" ref="form" :model="form" label-width="200px">
			...
			<el-form-item label="默认上传方式">
				<div>
					...
					<el-radio v-model="form.current" label="MinIo" @change="getRadio">MinIO</el-radio>
			...
			<!--本地存储-->
			<div v-if="form.current == 'Local'">
				<el-form-item label="">
					<div class="tips">多节点模式下,请勿使用本地存储</div>
				</el-form-item>
			</div>
			<!--MinIo存储-->
			<div v-if="form.current == 'MinIo'">
				<el-form-item label="存储空间名称 Bucket"><el-input v-model="form.minIo.bucket"
						class="max-w460"></el-input></el-form-item>
				<el-form-item label="ACCESS_KEY AK"><el-input v-model="form.minIo.accessKey"
						class="max-w460"></el-input></el-form-item>
				<el-form-item label="SECRET_KEY SK"><el-input v-model="form.minIo.secretKey"
						class="max-w460"></el-input></el-form-item>
				<el-form-item label="空间域名 Domain">
					<el-input v-model="form.minIo.domain" class="max-w460"></el-input>
