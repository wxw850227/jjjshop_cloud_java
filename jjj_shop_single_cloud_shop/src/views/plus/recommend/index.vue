    ...
    <el-form size="small" ref="form" :model="form" label-width="100px">
      ...
      >
        <el-input
          ...
          placeholder="请输入模块名称"
          class="max-w460"
          :disabled="form.isRecommend == 0 ? true : false"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="推荐商品">
        <el-radio-group v-model="form.choice">
          <el-radio :label="0" :disabled="form.isRecommend == 0 ? true : false"
            >按条件选择</el-radio
          >
          <el-radio :label="1" :disabled="form.isRecommend == 0 ? true : false"
            >自定义选择</el-radio
          >
        </el-radio-group>
      </el-form-item>
      ...
      <el-form-item size="small" label="" v-if="form.choice == 1">
        <el-button size="small" icon="Plus" @click="addClick"
          >添加商品</el-button
        >
      </el-form-item>
      <el-form-item label="">
                ...
                <div class="product-info">
                  <div class="pic">
                    <img
                      :width="30"
                      :height="30"
                      v-img-url="scope.row.productImage"
                    />
                  </div>
                </div>
              </template>
