<template>
  <div v-loading="loading" class="product-add">
    <!--form表单-->
    <el-form size="small" ref="form" :model="form" label-width="200px">
      ...
      <template v-if="activeName == '2'">
        ...
        <el-form-item v-if="form.applyRange == 20">
          <el-button class="mb10" @click="isProduct = true" type="primary" plain
            >添加商品</el-button
          >
          <el-table
        ...
        <el-form-item label="" v-if="form.applyRange == 30">
          ...
          <div>
            <el-tag
              ...
              class="mr10 mb10"
              type="info"
              v-if="categoryList.first.length > 0"
              v-for="(item, index) in categoryList.first"
              :key="item.categoryId"
            >
            ...
            <el-tag
              ...
              class="mr10 mb10"
              type="info"
              v-if="categoryList.second.length > 0"
              v-for="(item, index) in categoryList.second"
              :key="item.categoryId"
            >
              {{ item.parent ? item.parent + "→" + item.name : item.name }}
            </el-tag>
