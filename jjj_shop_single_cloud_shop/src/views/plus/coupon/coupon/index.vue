          ...
          >
            ...
            <el-table-column label="优惠券类型">
              <template #default="scope">
                <span v-if="scope.row.couponType && scope.row.couponType == 10"
                  >满减券</span
                >
                <span v-if="scope.row.couponType && scope.row.couponType == 20"
                  >折扣券</span
                >
              </template>
            </el-table-column>
            ...
            <el-table-column prop="seckillStock" label="有效期">
              <template #default="scope">
                <div v-if="scope.row.expireType == 10">
                  <span
                    >领取
                    <strong>{{ scope.row.expireDay }}</strong> 天内有效</span
                  >
                </div>
